...
## One-time: create GitHub repo (maintainer)

Full steps: [docs/GITHUB.md](docs/GITHUB.md)

From the repo root after scaffold exists:
...
Linux/macOS without the script:
...
### Option A — Open this repo (maintainers)
...
### Option B — Global install (any RTL / p4 project)
...
Use **`--copy`** if symlinks fail on NFS.
