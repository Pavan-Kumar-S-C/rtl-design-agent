...
| Quartus module build | quartus synthesis, compile, qpf, qsf, qshell, quartus_map, module build, fit, fitter, quartus standard | [quartus-module-build.md](quartus-module-build.md) | [topics/quartus-module-build.md](../../.cursor/skills/rtl-design/topics/quartus-module-build.md) (synth) · [@timing-analysis](../../.cursor/skills/timing-analysis/SKILL.md) (fit/STA) · [@sdc](../../.cursor/skills/sdc/SKILL.md) (module SDC) | — |
...
| MAS / RTL workflow | mas section, assumption, failure mode, debug logic, i_ port, o_ port, mas traceability, micro architecture | [mas-rtl-workflow.md](mas-rtl-workflow.md) | [topics/mas-rtl.md](../../.cursor/skills/rtl-design/topics/mas-rtl.md) | [templates/project-layout/docs/mas/](../../templates/project-layout/docs/mas/) |
...
| Testbench generation | testbench, tb, self-checking, scoreboard, stimulus, uvm-lite, simulation test, negative test, assumption test, functional test | [testbench-generation.md](testbench-generation.md) | [@testbench](../../.cursor/skills/testbench/SKILL.md) — **not @rtl-design** | — |
